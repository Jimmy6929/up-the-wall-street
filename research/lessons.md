...
- 2026-06-12 · SPCX · the prospectus quietly redefines what the company IS: "SpaceX" the ticker = SpaceX + xAI + X Holdings combined (common-control, retrospective) - the AI segment carries the losses. Read the S-1's entity/combination section BEFORE classifying any IPO; the name on the ticker is not the boundary of the business
