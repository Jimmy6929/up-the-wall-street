...
Data path with graceful degradation: **SEC EDGAR script → web search → ask the user to paste.** Every figure in a note records where it came from and as of when. If a required number can't be sourced, say so — do not guess.
